        ...
        <center>
          <Col>
            ...
            <p className="texto-descripcion">
              ...
              <br />
              <br />
              Por eso consideramos que la comunicación es un pilar fundamental
              en las relaciones que generamos.
            </p>
          </Col>
          </center>
      </Row>
      ...
      <Row>
        ...
        <Col sm={12} md={4}>
          <Card className="card-mision" >
            ...
            <Card.Body>
              <Card.Title className="titulo-valores text-center">Misión</Card.Title>
        ...
        <Col sm={12} md={4}>
          <Card className="card-mision" >
            ...
            <Card.Body>
              <Card.Title className="titulo-valores text-center">Visión</Card.Title>
              <Card.Text className="text-valores text-center">
        ...
        <Col sm={12} md={4}>
          <Card className="card-mision" >
            ...
            <Card.Body>
              <Card.Title className="titulo-valores text-center">Valores</Card.Title>
              <Card.Text className="text-valores text-center">
